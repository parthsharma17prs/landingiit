...
export const Footer = () => {
    ...
    return (
        <footer className="my-8 px-4 max-w-5xl text-base-content mx-auto">
            <div className="relative bg-white rounded-3xl max-w-5xl mx-auto px-4 py-10 flex flex-col md:flex-row justify-between items-center gap-6">
                ...
                <div className="flex flex-col md:flex-row items-start justify-between gap-4 md:gap-10 px-2 md:px-8 flex-1">
                    <div className="flex flex-col items-start gap-2">
                        <Link
                            href="/"
                            className="flex flex-row gap-1 items-center justify-start text-2xl font-display font-extrabold text-[#222222]"
                        >
                            ActivationLed
                        </Link>
                    ...
                    <div className="flex flex-col md:flex-row gap-2 md:gap-20 items-start">
                        <div className="flex flex-col gap-1 md:gap-4">
                            <h4 className="uppercase font-display text-md text-neutral-400 font-semibold">
                                Resources
                            </h4>
                            <div className="flex flex-wrap md:flex-col gap-2 text-sm text-neutral-600 items-start">
                                <Link
                                    className="text-neutral-500 whitespace-nowrap font-medium"
                                ...
                                <Link
                                    className="pointer-events-none text-neutral-500 whitespace-nowrap font-medium"
                                    href="/resources/blog"
                                >
                                    Blog{" "}
                                    <span className="inline-flex ml-1 py-0.5 px-3 bg-gray-100 text-xs rounded-xl -rotate-3 text-neutral-600">
                                        soon
                                    </span>{" "}
                                </Link>
                                <Link
                        ...
                        <div className="hidden md:flex flex-col gap-1 md:gap-4">
                            <h4 className="uppercase whitespace-nowrap font-display text-md text-neutral-400 font-semibold">
                                Company{" "}
                                <span className="inline-flex ml-1 py-0.5 px-3 bg-gray-100 text-xs rounded-xl rotate-3 text-neutral-600">
                                    soon
                                </span>
                            </h4>
                            <div className="flex gap-2 flex-wrap md:flex-col text-sm text-neutral-600 items-start">
                                <Link
                                    className="pointer-events-none text-neutral-500 whitespace-nowrap font-medium"
                        ...
                        <div className="hidden md:flex flex-col gap-1 gap-4">
                            ...
                            <div className="flex flex-col gap-2 text-sm text-neutral-600 items-start">
                                <Link
                                    className="pointer-events-none text-neutral-500 whitespace-nowrap font-medium"
            ...
            <div className="my-3 px-4 md:px-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 text-sm text-neutral-500">
